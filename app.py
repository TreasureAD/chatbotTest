...
# Add an error handler to log exceptions
...
def get_chat_response(user_input):
    conn = sqlite3.connect('/Users/treasure.davis/Desktop/Treasure\'s Surface 3-23-2023/Personal/ChatBot-Starter-main copy 2/it_Department.txt')  # Connect to the existing database
    cursor = conn.cursor()
...
conn = sqlite3.connect('/Users/treasure.davis/Desktop/Treasure\'s Surface 3-23-2023/Personal/ChatBot-Starter-main copy 3/chat_logs.db')

# Set up SQLite database connection
def create_chat_log_table(user_id):
    conn = sqlite3.connect(f'/Users/treasure.davis/Desktop/Treasure\'s Surface 3-23-2023/Personal/ChatBot-Starter-main copy 3/{user_id}_chat_logs.db')
    cursor = conn.cursor()
